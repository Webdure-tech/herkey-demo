...
class Event(TimeStampedModel, ActivatorModel, TitleDescriptionModel, Model):
    ...
    type = models.CharField(
        max_length=10, choices=TYPE_CHOICES, default="SCHEDULED", verbose_name="Type"
    )
    ...
    stream_session_id = models.CharField(
        null=True, blank=True, max_length=100, verbose_name="Stream Session ID"
    )
...
class EventParticipant(TimeStampedModel, Model):
...
class EventAttachment(TimeStampedModel, Model):
    ...
    attachment_cloud_id = models.CharField(
        null=True, max_length=100, verbose_name="Attachment"
    )

    attachment_name = models.CharField(
        null=True, max_length=100, verbose_name="Attachment Name"
    )
